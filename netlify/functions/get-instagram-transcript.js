exports.handler = async function (event, context) {
  ...
  try {
    ...
    // Call SocialKit Instagram Transcript API
    const apiUrl = `https://api.socialkit.dev/instagram/transcript?access_key=${encodeURIComponent(accessKey)}&url=${encodeURIComponent(videoUrl)}`;
    ...
    const transcript = apiData.data?.transcript || apiData.transcript;
